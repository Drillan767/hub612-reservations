	...
	m.Register(func(app core.App) error {
		jsonData := `[
			...
			},
			{
				...
				"system": false,
				"type": "base",
				"updateRule": "@request.auth.id != \"\" && (@request.auth.is_admin = true || @request.auth.company.id = id)",
				"viewRule": "@request.auth.id != \"\" && (@request.auth.is_admin = true || @request.auth.company.id = id)"
			},
			{
				"createRule": null,
				"deleteRule": null,
